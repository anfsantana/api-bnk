#defmodule ApiBnK.Accounts.UserResolver do
#  alias ApiBnK.Accounts
#
...
#         {:ok, _ } <- ApiBnK.Accounts.store_token(user, jwt) do
#      {:ok, %{token: jwt}}
#    end
#  end
#
#  def logout(_args,  %{context: %{current_user: current_user, token: _token}}) do
#    ApiBnK.Accounts.revoke_token(current_user, nil)
#    {:ok, current_user}
#  end
#
